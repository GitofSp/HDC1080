...
//uint8_t IIcMemWrite(uint8_t SlaveAddr, uint8_t RegisterAddr, uint8_t *Txbuf, uint8_t ByteCnt)
//{
//	uint8_t i,ret = 0;
//	
//	IIC_Start(); 
...
//uint8_t IIcMasterSend(uint8_t SlaveAddr, uint8_t *Txbuf, uint8_t ByteCnt)
//{
//	uint8_t i,ret = 0;
//	
//	IIC_Start(); 
...
//uint8_t IIcMasterRead(uint8_t SlaveAddr, uint8_t *Rxbuf, uint8_t ByteCnt)
//{
//	uint8_t i,ret = 0;
//	
//	IIC_Start(); 
...
//	if(IIC_Wait_Ack()){
//		printf("IIcMasterRead ack err\r\n");
//		ret = 1;
//	}
//	//delay
//	for(i=0;i<ByteCnt;i++){
//		Rxbuf[i] = IIC_Read_Byte(1);
//	}
//	IIC_Stop();
//	
//	return ret;
